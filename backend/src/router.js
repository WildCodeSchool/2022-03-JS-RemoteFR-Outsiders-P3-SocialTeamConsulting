...
router.get("/accepte/validation/:id", middlewareAll, AccepteController.readWithIntervenant);
router.get("/accepte/refuseduser/:userId", middlewareAll, AccepteController.readRefusedIntervenantByMission);
router.get("/accepte/modification/:id", middlewareAll, AccepteController.changeInter);
router.put("/accepte/annulation/:missionId/:userId", AccepteController.deleteAppliedMissionByIntervenant);
...
router.get("/administrateurs", middlewareAdministrateur, AdministrateursController.browse);
router.get("/administrateurs/bymail/:email", middlewareAdministrateur, AdministrateursController.browseByEmail);
router.put("/administrateurs/:id", middlewareAdministrateur, AdministrateursController.edit);
router.put("/administrateurs/mpd/:id", verifyMDP, AdministrateursController.editMDP);
router.post("/administrateurs", middlewareAdministrateur, AdministrateursController.add);
...
router.get("/associations/bymail/:email", middlewareAll, AssociationsController.browseByEmail);
...
router.get("/intervenants/bymail/:email", middlewareAll, IntervenantsController.browseByEmail);
router.get("/intervenants/download/:filename", middlewareAdministrateur, IntervenantsController.download);
router.get("/intervenants/findpath/:filename", middlewareAdministrateur, IntervenantsController.browsePath);
router.put("/intervenants/:id", middlewareAll, IntervenantsController.edit);
router.put("/intervenants/etat/:id", middlewareAdministrateur, IntervenantsController.editEtat);
...
router.get("/missions/validated", middlewareAll, MissionsController.browseValidatedMissions);
router.get("/missions/history/:id", middlewareIntervenant, MissionsController.browseMissionsHistory);
router.get("/missions/assohistory/:id", middlewareAssociation, MissionsController.browseAssoMissionsHistory);
router.get("/missions/nonacceptee/:id", middlewareAll, MissionsController.browseMissionsNotAccepted);
